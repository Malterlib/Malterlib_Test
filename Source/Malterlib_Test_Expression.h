...
#		define DMibExpr(_Expression) NMib::NExpression::fg_GetExpression(_Expression, DMibStringizeUTF8(_Expression))
#		define DMibELExpr(_Expression) NMib::NExpression::fg_GetLambdaExpression([&]() {return _Expression;}, DMibStringizeUTF8(_Expression))
#		define DMibLExpr(_Expression) NMib::NExpression::fg_GetLambdaExpressionNoEval([&]() {return _Expression;}, DMibStringizeUTF8(_Expression))
...
#ifndef DMibPNoShortCuts
using namespace NMib::NExpression;
#endif
