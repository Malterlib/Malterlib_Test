		...
		namespace NPrivate
		{
			...
			public:
				...
				public:
					...
					NPtr::TCAutoClearPtr<CThreadLocal const> m_pInherit;
				...
				NThread::TCThreadLocal<CThreadLocal, NMem::CAllocator_Heap, NThread::EThreadLocalFlag_Inherit> m_ThreadLocal;
			...
			static NAggregate::TCAggregate<CTestManager, 256> g_Tests = {DAggregateInit};
...
#				if DMibEnableSafeCheck > 0
					bint bOldAssethThrow = NDebug::fg_MibSafeCheckSetThrowsException(true);
#				endif
...
#				if DMibEnableSafeCheck > 0
					NDebug::fg_MibSafeCheckSetThrowsException(bOldAssethThrow);
#				endif
			...
			class CDefaultTestResults : public CTextTestResults
			{
				...
				{
					NMib::fg_MalterlibConOut(_Color, _Text);
				}
			};
...
#			endif
		...
		void CTestResultParser::fp_HandleRecord(NStr::CStr const &_Text)
		{
			...
			NRegistry::CRegistry_CStr *pChild = nullptr;
		...
		void CTestResultParser::fs_DecodeMemoryResults(NRegistry::CRegistry_CStr const &_Registry, CTestMemoryResults &_Results)
		{
			return NPrivate::CRegistryTestResults::fs_DecodeMemoryResults(_Registry, _Results);
		}
		void CTestResultParser::fs_DecodePerformanceResults(NRegistry::CRegistry_CStr const &_Registry, CTestPerformanceResults &_Results)
		{
			return NPrivate::CRegistryTestResults::fs_DecodePerformanceResults(_Registry, _Results);
		}
		void CTestResultParser::fs_DecodeResult(NRegistry::CRegistry_CStr const &_Registry, CTestResult &_Results)
		{
