...
namespace NMib
{
	namespace NTest
	{
		...
		class CTestMemoryMeasure : NMem::CReportMemory
		{
			...
			NContainer::TCMap<mint, CAllocatorStats *, NMib::CSort_Default, NMem::CAllocator_NonTrackedHeap> mp_ActiveAllocators;
			NContainer::TCMap<CAllocationKey, CAllocation, CSort_Default, NMem::CAllocator_NonTrackedHeap> mp_Allocations;
			NContainer::TCMap<NStr::CStrNonTracked, CAllocatorStats, CSort_Default, NMem::CAllocator_NonTrackedHeap> mp_Allocators;
			CAllocatorStats mp_AllAllocations;

			NContainer::TCMap
				<
					NStr::CStrNonTracked
					, NContainer::TCVector<CAllocatorStats, NMem::CAllocator_NonTrackedHeap>
					, NMib::CSort_Default
